		...
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					...
					<?php
                        $sql_tenspchitiet = mysqli_query($con, "SELECT * FROM tbl_sanpham WHERE sanpham_id='$id'");
                        $row_tenspchitiet = mysqli_fetch_array($sql_tenspchitiet);
                        
                    ?>
					<li><?php echo $row_tenspchitiet['sanpham_name'] ?></li>
				</ul>
			</div>
		</div>
	</div>
