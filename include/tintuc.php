	...
	<div class="welcome py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
            ...
            <?php
                ...
                AND tbl_danhmuc_tin.danhmuctin_id= '$id_danhmuc' " );
			...
			<div class="row">
				...
				<div class="col-lg-8 welcome-left">
					<h4><a href="index.php?quanly=chitiettin&id=<?php echo $row_baiviet['baiviet_id'] ?>"><?php echo $row_baiviet['tenbaiviet'] ?></a></h4>
