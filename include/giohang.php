<?php
	if(isset($_POST['themgiohang'])){
		...
		if(isset($_POST['phone'])){
			$phone = $_POST['phone'];                //fix different yt
		}else{
			$phone ='';
		}
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				...
				<?php
					if(isset($_SESSION['dangnhap_home'])){
						echo '<p style="color:#000;">Xin chào '.$_SESSION['dangnhap_home'].'✌️'.''.'<a style="font-weight: bold;" href="index.php?quanly=giohang&dangxuat=1">Đăng xuất</a>';
					}else{
						echo '';
					}
				?>
					...
					<form action="" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								...
								?>
								<input type="submit" name="thanhtoan" class="btn btn-primary" style="width: 20%;" value="Thanh Toán" >
							</div>
						</div>
					</form>
					<!-- <div class="checkout-right-basket">
						<a href="payment.html">Make a Payment                                                     thanh toán qua thẻ
