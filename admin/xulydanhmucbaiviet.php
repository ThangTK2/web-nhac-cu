        ...
        <div class="row">
            ...
            ?>
                    <div class="col-md-4">
                        ...
                        <form action="" method="POST">
                            <input type="text" class="form-control" name="danhmuc" placeholder="Tên Danh Mục Bài Viết"><br>
                            <input type="submit" name="themdanhmuc" value="Thêm Danh Mục Bài Viết" class="btn btn-primary">
                        </form>
                    </div>
                <?php
                }
            ...
            <div class="col-md-8">
                <h5>Liệt Kê Danh Mục Bài Viết</h5>
                <?php
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="?xoa=<?php echo $row_category['danhmuctin_id'] ?>">Xóa</a> || 
                        <a href="?quanly=capnhat&id=<?php echo $row_category['danhmuctin_id'] ?>">Cập Nhật</a></td>
                    </tr>
                    <?php
                        }
                    ?>
